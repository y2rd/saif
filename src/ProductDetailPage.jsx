                    ...
                    {product.customFields.filter(f => f.label?.trim()).map((field) => (
                      <div key={field.id} className="flex items-center justify-between gap-3 bg-white/60 p-1.5 px-2 rounded-2xl border border-gray-100">
                        ...
                        <input
                          ...
                          placeholder=""
                          className="w-36 sm:w-44 h-9 sm:h-9.5 px-3 bg-white border border-gray-300 rounded-xl text-xs sm:text-sm text-gray-900 outline-none focus:border-gray-800 focus:ring-1 focus:ring-gray-800 transition shadow-2xs text-right"
                        />
                      </div>
                    ))}
                  </div>
