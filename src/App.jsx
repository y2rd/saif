...
export default function App() {
  ...
  return (
    ...
    >
      ...
      {/* الشريط العلوي الخاص بأقصى الصفحة: العربية | USD ومعه في نفس الصف البحث */}
      <div className="bg-[#F9FAFB] border-b border-gray-200/80 px-3 sm:px-8 py-2 sticky top-0 z-40 backdrop-blur-md" style={{ paddingTop: (!storeConfig.announcements?.length && !storeConfig.announcement) ? 'calc(env(safe-area-inset-top) + 8px)' : undefined }}>
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
          ...
          <div className="relative shrink-0">
            <button
              ...
              className="px-2.5 sm:px-3 py-1 rounded-full border border-gray-200 bg-gray-50/90 hover:bg-gray-100 text-black text-[11px] sm:text-xs font-light flex items-center gap-1.5 transition cursor-pointer shadow-2xs"
          ...
          <div className="flex-1 w-full min-w-0">
            <div className="relative w-full flex items-center">
              <input
                ...
                className="w-full pr-7 sm:pr-8 pl-6 sm:pl-7 h-6 sm:h-6.5 bg-gray-50/90 hover:bg-gray-100/90 focus:bg-white border border-gray-200 focus:border-gray-900 rounded-full text-[10.5px] sm:text-[11px] outline-none transition shadow-2xs placeholder:text-gray-400 font-light leading-none"
              />
      ...
      <header className="bg-white border-b border-gray-100 px-3 sm:px-8 py-2 sm:py-2.5 z-30 shadow-2xs relative">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
            ...
            <div className="relative" ref={userMenuRef}>
              <button
                ...
                className="p-2 sm:px-3 sm:py-1.5 rounded-full border border-gray-200/90 bg-white hover:bg-gray-50 text-gray-700 hover:text-black transition flex items-center gap-1.5 cursor-pointer shadow-2xs shrink-0 active:scale-95 text-xs font-light"
            ...
            <button
              ...
              className={`relative w-8 h-8 sm:w-9 sm:h-9 rounded-full border border-gray-200 text-gray-700 bg-white hover:bg-gray-50 transition-all duration-200 active:scale-95 shadow-2xs cursor-pointer flex items-center justify-center shrink-0 ${
                            ...
                            <div className="p-3 sm:p-4 pt-1.5 sm:pt-2">
                              ...
                              {item.productType === 'exchange' || (typeof item.exchangeCurrencyName === 'string' && item.exchangeCurrencyName.trim().length > 0) ? (
                                <button
                                  ...
                                  className="w-full py-2 sm:py-2.5 rounded-lg sm:rounded-xl border border-teal-200 hover:border-teal-700 bg-teal-50/60 hover:bg-teal-100/60 active:scale-98 text-teal-900 font-bold text-xs sm:text-[13px] transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer shadow-2xs group/btn"
                                >
                                  <i className="fa-solid fa-right-left text-teal-700 text-xs"></i>
                      ...
                      {activeFeatures.map((feat, fIndex) => (
                        ...
                        >
                          ...
                          <div className="store-feature-icon-wrapper w-8 h-8 sm:w-14 sm:h-14 rounded-full bg-[#0b1220] text-white flex items-center justify-center text-xs sm:text-xl mb-1.5 sm:mb-5 shadow-xs group-hover:scale-105 transition-transform duration-300 shrink-0">
                            {feat.customIconUrl ? (
                              <img src={feat.customIconUrl} alt="" className="w-4 h-4 sm:w-7 sm:h-7 object-contain brightness-0 invert" />
                            ) : (
                              <i className={`${feat.icon || 'fa-solid fa-bolt'} text-white text-[11px] sm:text-lg`}></i>
                            )}
                          </div>
            ...
            <div className="p-3 pt-1">
              ...
              {p.productType === 'exchange' || (typeof p.exchangeCurrencyName === 'string' && p.exchangeCurrencyName.trim().length > 0) ? (
                <button
                  ...
                  className="w-full py-2 rounded-xl border border-teal-200 hover:border-teal-700 bg-teal-50/60 hover:bg-teal-100/60 active:scale-98 text-teal-900 font-bold text-xs transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer shadow-2xs"
                >
                  <i className="fa-solid fa-right-left text-teal-700 text-xs"></i>
                  <span>طلب المبادلة</span>
                </button>
                ...
                <button
                  ...
                  className="w-full py-2 rounded-xl border border-gray-200 hover:border-black bg-white hover:bg-gray-50 active:scale-98 text-gray-900 font-bold text-xs transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer shadow-2xs"
                >
                  <i className="fa-solid fa-pen-to-square text-gray-700 text-xs"></i>
                  <span>تحديد البيانات</span>
                </button>
              ) : (
                <button
